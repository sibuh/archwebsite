          ...
          >
            {data.map((project) => (
              <li
                ...
                className="w-fit mx-auto max-w-full flex flex-col md:flex-row items-center md:items-start gap-2 bg-white shadow-md rounded-md p-4 cursor-pointer overflow-auto"
              >
                {/* Text Content */}
